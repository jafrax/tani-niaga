<?php 
  if(!isset($_GET['cari'])){     
    ...
    $new = "SELECT id_buku, judul_buku, harga, cover FROM tb_buku ORDER BY id_buku DESC ";
...
?>
              ...
              <div class="product-item">
                <div class="product-img">
                  <a href="?p=buku_detail&id_buku=<?php echo $row['id_buku']; ?>">
                    <img src="img/book/<?php echo $row['cover']; ?>" alt="" style="height:200px; width:150px;">
 ...
 <!-- New Arrivals -->
    <section class="section-wrap new-arrivals nopadding">
      <div class="container">
