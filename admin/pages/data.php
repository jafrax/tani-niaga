                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    ...
                                                    if(strlen(trim($row['sinopsis']))>150) echo " [...]"; 
                                                ?>
                                            </td>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <input type="hidden" value="-" placeholder="Masukkan Pengarang Buku" id="pengarang" name="pengarang" class="form-control" required>
                        <!-- </div> -->
                        <!-- <div class="form-group"> -->
                            <!-- <label for="penerbit">Penerbit</label> -->
                            <input type="hidden" value="-" placeholder="Masukkan Penerbit Buku" id="penerbit" name="penerbit" class="form-control" required>
                        <!-- </div> -->
                        <div class="form-group">
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <input type="hidden" value="0" placeholder="Masukkan Halaman Buku" id="halaman" name="halaman" class="form-control" required>
                        <!-- </div> -->
                        <div class="form-group">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <!-- <div class="form-group"> -->
                            <!-- <label for="pengarang">Pengarang</label> -->
                            <input type="hidden" placeholder="Masukkan Pengarang Buku" id="pengarang" name="pengarang" class="form-control hapus_pengarang" readonly>
                        <!-- </div> -->
                        <!-- <div class="form-group"> -->
                            <!-- <label for="penerbit">Penerbit</label> -->
                            <input type="hidden" placeholder="Masukkan Penerbit Buku" id="penerbit" name="penerbit" class="form-control hapus_penerbit" readonly>
                        <!-- </div> -->
